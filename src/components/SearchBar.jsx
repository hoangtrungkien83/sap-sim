...
export default function SearchBar({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      <button className="absolute inset-0 bg-black/30" onClick={handleClose} aria-label="Đóng" />
      <div className="relative bg-white max-w-xl mx-auto mt-20 rounded-lg shadow-xl overflow-hidden">
        <div className="flex items-center gap-2 border-b border-[var(--fiori-tile-border)] px-4 py-3">
          ...
          <input
            ...
            placeholder="Tìm app, transaction, danh sách..."
            className="flex-1 outline-none text-sm"
          />
          <button onClick={handleClose} className="p-1 hover:bg-gray-100 rounded" aria-label="Đóng">
